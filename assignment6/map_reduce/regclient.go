/*
A package to keep track of the registry client functions.
*/
package regclient
...
/*
A struct to represent a client wrapper
*/
...
Parameters:
	nakedclient - the naked client pointer

Returns:
	a wrapped client for use with registry methods
*/
